/**
 * Created by yantianyu on 2015/10/10.
 */
...
Swipe.prototype = {
    setup: function () {
        ...
        while (index--) {
            ...
            el.style.width = this.width - this.CustomDistance;
    ...
    slide: function (index, duration) {
        ...
        style.MozTransition = style.webkitTransition = 'translate3d(' + -(index * (this.width - this.CustomDistance)) + 'px,0,0)';
