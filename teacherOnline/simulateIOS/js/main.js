$(function(){
    ...
    //可调节的参数
    var loadingPath='http://p1.me2.fm/dd/';
    var manifest=[
    ...
    var apps=['照片','百度地图','优酷视频','微信','大众点评','手机淘宝','Uber','携程旅行','新浪微博','Metoo','网易新闻','QQ音乐','美颜相机','支付宝','QQ','京东','Instagram','Facebook','滴滴打车'];
...
//        }})
		window.location='http://metoo.fm/down';
    });
